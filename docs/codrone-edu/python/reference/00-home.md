...
<div class="boxLanding">
  ...
  <h3>Connection</h3>
    ...
    <div class="box-reference-shadow margin-top-30"> 
        ...
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/10-set_pitch">set_pitch()</a>  
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/11-set_roll">set_roll()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/12-set_throttle">set_throttle()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/13-set_yaw">set_yaw()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/14-spiral">spiral()</a>    
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/15-square">square()</a>  
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/16-sway">sway()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/17-triangle">triangle()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/18-turn_degree">turn_degree()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/19-turn_left">turn_left()</a>  
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/20-turn_right">turn_right()</a>     
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/21-goto_waypoint">goto_waypoint()</a>
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/22-set_waypoint">set_waypoint()</a>
        ...
        <a href="/docs/codrone-edu/python/Flight-Commands-Movement/38-send_absolute_position">send_absolute_position()</a>
